class MaintenancesController < ApplicationController
  ...
  before_action :set_machines, only: %i[ new edit create update]
  ...
  private
    ...
    def maintenance_params
      params.require(:maintenance).permit(:type_machine, :Type_maintenance, :name_machine, :date, :email, :machines_id, :cities_id, :materials_id)
    end
    def set_materials
