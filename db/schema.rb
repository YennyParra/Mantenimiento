...
ActiveRecord::Schema[7.0].define(version: 2023_09_06_062038) do
  ...
  create_table "maintenances", force: :cascade do |t|
    ...
    t.index ["machines_id"], name: "index_maintenances_on_machines_id"
  ...
  add_foreign_key "maintenances", "machines", column: "machines_id"
