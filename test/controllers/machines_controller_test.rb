...
class MachinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create machine" do
    assert_difference("Machine.count") do
      post machines_url, params: { machine: { description: @machine.description, name: @machine.name, photo: @machine.photo, type: @machine.type } }
    end
  ...
  test "should update machine" do
    patch machine_url(@machine), params: { machine: { description: @machine.description, name: @machine.name, photo: @machine.photo, type: @machine.type } }
